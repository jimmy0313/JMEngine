...
namespace JMEngine
{
	namespace rpc
	{
		...
		public:
			JME_IPM_RpcCallback(JME_IPM_RpcCallback::RpcHandler cb);
			JME_IPM_RpcCallback(JME_IPM_RPCClientPtr client, JME_IPM_RpcCallback::RpcHandler cb, size_t t, JME_IPM_RpcCallback::RpcDeadHandler dcb, int methodId);

			static JME_IPM_RpcCallback::JME_IPM_RpcCallbackPtr create(JME_IPM_RpcCallback::RpcHandler cb);
			static JME_IPM_RpcCallback::JME_IPM_RpcCallbackPtr create(JME_IPM_RPCClientPtr client, JME_IPM_RpcCallback::RpcHandler cb, size_t t, JME_IPM_RpcCallback::RpcDeadHandler dcb, int methodId);

		public:
			JME_IPM_RpcCallback::RpcHandler _cb;	//回调函数
			DeadTimePtr _dt;	//超时时间
			bool _checkDead;
		};
		...
		public:
			...
			static JMEngine::rpc::JME_IPM_RPCClient::JME_IPM_RPCClientPtr create();
